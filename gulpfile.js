...
var drawmeJsPath    = 'src/app/**/*.js',
    drawmeCssPath   = 'src/app/styles.css',
    drawmeFontsPath = 'src/assets/fonts/*';
...
gulp.task('drawme_js', function(){
  return gulp.src(drawmeJsPath)
  .pipe(order([
    "**/**.module.js",
    "**/*.js"
  ]))
  .pipe(concat('drawme.js'))
  .pipe(gulp.dest(buildPath + '/js'));
});

gulp.task('drawme_css', function(){
  return gulp.src(drawmeCssPath)
  .pipe(concat('drawme.css'))
  .pipe(gulp.dest(buildPath + '/css'));
});

gulp.task('drawme_fonts', function(){
  return gulp.src(drawmeFontsPath)
...
gulp.task('watch', function(){
  ...
  gulp.watch(drawmeJsPath, ['drawme_js']);
  gulp.watch(drawmeCssPath, ['drawme_css']);
});

// Выполняет сборку
gulp.task('build', ['vendors_js', 'vendors_css', 'drawme_js', 'drawme_css','drawme_fonts']);
